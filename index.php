...
<body>
  <button class="btn btn-success baixar"> 
      <a href="gerar_planilha.php">baixar relatorio</a>
  </button>
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" name="busca"  placeholder="Digite a Matrícula">

...
<head>
  <title>planilha inspetoria</title>
  <!-- Required meta tags -->
  <meta charset="utf-8">
...
<body>
  ...
  $arquivo = 'planilha_inspetoria.xls';
  // Criamos uma tabela HTML com o formato da planilha
  $html = '';
  $html .= '<table border="1">';
  $html .= '<tr>';
  $html .= '<td colspan="6"> planilha ocorrencias </tr>';
  $html .= '</tr>';
  ...
  $result_msg_contatos = "SELECT * FROM ocorrencias";
  ...
  while ($row_msg_contatos = mysqli_fetch_assoc($resultado_msg_contatos)) {
    ...
    $html .= '<td>' . $row_msg_contatos["hora_da_ocorrencia"] . '</td>';
    $html .= '<td>' . $row_msg_contatos["data_da_ocorrencia"] . '</td>';
    $html .= '<td>' . $row_msg_contatos["ocorrencia"] . '</td>';
